package com.mx.lb.androidcircleimage.widget;
...
import com.mx.lb.androidcircleimage.R;

import java.lang.ref.WeakReference;

/**
 * Created on 2015/11/14 14:46
...
public class RoundImageViewByXfermode extends ImageView {
    ...
    public RoundImageViewByXfermode(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.
                obtainStyledAttributes(attrs, R.styleable.RoundImageViewByXfermode);
        ...
        if (bitmap == null || bitmap.isRecycled()) {
            ...
            if (drawable != null) {
                ...
                if (type == TYPE_ROUND) {
                    ...
                    scale = Math.max(getWidth() * 1.0f, getHeight() * 1.0f);
                } else {
                ...
                drawCanvas.drawBitmap(
                        mMaskBitmap,0,0,mPaint);

                mPaint.setXfermode(null);
                //将准备好的bitmap绘制出来
                canvas.drawBitmap(bitmap,0,0,null);
                //bitmap缓存起来，比曼每次调用onDraw（），分配内存
